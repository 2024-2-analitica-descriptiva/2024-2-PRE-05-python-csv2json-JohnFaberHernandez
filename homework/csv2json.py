...
app()
#en la terminal debo digitar el siguiete comando "pip3 isntall nicegui", 
# luego en la terminal "homework\csv2json"
#Luego ejecuto el programa y en navegador copio "files/drivers.json" y asi pasamos de CSV a Json
